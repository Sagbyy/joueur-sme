...
import org.univ_paris8.iut.montreuil.qdev.tp2024.gr3.jeuQuizz.entities.tools.Langue;
...
public class Joueur {
    ...
    public Joueur(int id, String pseudo, String prenom, String centreInterets, int anneeNaissance, Langue langue, List<ScoreDTO> listeScores) {
        this.id = id;
        this.pseudo = pseudo;
        this.prenom = prenom;
